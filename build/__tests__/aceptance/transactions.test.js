...
it('Should transactions file exists', () => __awaiter(void 0, void 0, void 0, function* () {
    let checkFileExistence = yield fileExists(transactionsRelativePath);
    expect(checkFileExistence).toBe(true);
    // const response = await request(app).get('/users');
    // expect(response.statusCode).toBe(200);
    // expect(response.body).toEqual([]);
}));
it('Should transactions file readable', () => __awaiter(void 0, void 0, void 0, function* () {
    let checkFileReadable = yield fileReadable(transactionsRelativePath);
    expect(checkFileReadable).toBe(true);
    // const response = await request(app).get('/users');
    // expect(response.statusCode).toBe(200);
    // expect(response.body).toEqual([]);
}));
it('Should transactions file json', () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (0, fs_1.readFileSync)(transactionsRelativePath, { encoding: 'utf8' });
